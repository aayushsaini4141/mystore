                      ...
                      {order.orderItems && order.orderItems.map((item)=> <li className="grid grid-cols-6 pb-2 border-b" key={item.product}>
                          ...
                          <div className="sm:col-span-2 col-span-2 pt-3 mx-1">
                              <div className="flex  items-center space-x-2 text-sm  justify-between">
                                  <span className="text-gray-400 sm:text-md text-sm">{item.quantity} x &#8377 {item.price}</span>
                                  <span className="text-purple-400 font-semibold inline-block">&#8377{item.quantity * item.price}</span>
                              </div>
                          </div>
                      </li> ) }
